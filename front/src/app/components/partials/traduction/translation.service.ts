...
export class TranslationService {
  ...
  private translations: { [key: string]: { [key: string]: string } } = {
    fr: {
      'BILAN_GENERATION' : 'Génération du Bilan',
      // Admin
...
'Create': 'Créer',
'Close': 'Fermer',
'PERIODE_PERSONNALISEE': 'Periode personnalisée',
'ANNEE_WITH_YEAR': 'Année',
'PERIODE': 'Période',
...
'PERIODICITE_TRIMESTRIEL': 'Trimestriel',
'PERIODICITE_SEMESTRIEL': 'Semestriel',
'PERIODICITE_ANNUEL': 'Annuel',

'BILAN_GLOBAL': 'Bilan global (conventions et factures) ',
'BILAN_CONVENTIONS': ' Bilan conventions',
'BILAN_FACTURES': 'Bilan factures',
'BILAN': 'Bilan',


    },
    en: {
'Bilan des clients' : 'Client Overview',
...
'Total Impayé': 'Total Unpaid',
'dont': 'including',
'en souffrance': 'overdue',
'Taux Conformité': 'Compliance Rate',
'Distribution Paiements': 'Payment Distribution',
'Évolution Annuelle': 'Annual Evolution',
'Évaluation par Critère': 'Criteria Evaluation',
'Points Forts': 'Strengths',
'Points à Améliorer': 'Areas for Improvement',
'Aucun point fort identifié': 'No strengths identified',
'Aucun point faible identifié': 'No weaknesses identified',
'Chargement du bilan client...': 'Loading client report...',
...
'Référence paiement:': 'Payment reference:',
'Timing:': 'Timing:',
'Jours de retard:': 'Days late:',
'Voir Détails': 'View Details',
'Bilan des Clients': 'Client Overview',
'Gestion et suivi de vos clients': 'Manage and track your clients',
'Chargement des clients...': 'Loading clients...',
'Total Clients': 'Total Clients',
'Score Moyen': 'Average Score',
'Total Impayés': 'Total Overdue',
'Valeur Totale Contrats': 'Total Contract Value',
'Distribution des Notes': 'Rating Distribution',
'Excellent': 'Excellent',
'Bon': 'Good',
'Médiocre': 'Poor',
'Filtres': 'Filters',
'Nom ou code client...': 'Client name or code...',
'Clients avec mauvais paiement': 'Clients with poor payment',
'Score Minimum': 'Minimum Score',
'Liste des Clients': 'Client List',
'Score': 'Score',
'Conv.': 'Agrmt.',
'Aucun client trouvé': 'No clients found',
'Aucun comportement de paiement enregistré': 'No payment behavior recorded',
'Très mauvais': 'Very poor',

'BILAN_GENERATION' : ' Bilan Generation',
'Bilan des revenus': 'Revenue Overview',
'Bilan des conventions et factures': 'Agreements and Invoices Overview',
'Personnalisé': 'Custom',
'Année': 'Year',
'Du': 'From',
'Au': 'To',
'Type de bilan': 'Report Type',
'Bilan Complet': 'Complete Report',
'Bilan des Conventions': 'Agreements Report',
'Bilan des Factures': 'Invoices Report',
'Génération du bilan en cours...': 'Generating report...',
'Détail des éléments': 'Items Details',
'HT': 'Excl. Tax',
'Structure': 'Structure',
'Fact.': 'Inv.',
'Aucune donnée trouvée pour la période sélectionnée': 'No data found for the selected period',
'Conv': 'Agrmt',
'Anc': 'Arch',
'Fact': 'Inv',
'En cours': 'In Progress',
...
// Modal texts
'Détail des factures': 'Invoice Details',
'impayées': 'unpaid',
'Total:': 'Total:',
'Date fact.': 'Invoice Date',
'Avance': 'Advance',
...
'BILAN_GLOBAL': 'Global Report (Agreements + Invoices)',
'BILAN_CONVENTIONS': 'Agreements Report',
'BILAN_FACTURES': 'Invoices Report',
'BILAN': 'Report',
'Chargement du bilan...': 'Loading report...',
'Bilan de la Convention :': 'Agreement Report:',
'Structure Resp.': 'Responsible Structure',
'Structure Bén.': 'Beneficiary Structure',
'N/A': 'N/A',
'RÉCAPITULATIF FINANCIER': 'FINANCIAL SUMMARY',
'Taux de recouvrement': 'Collection Rate',
'RÉCAPITULATIF DES FACTURES': 'INVOICES SUMMARY',
'Détail des Factures': 'Invoices Details',
'Réf. paiement': 'Payment Ref.',
'Total TTC': 'Total incl. Tax',
'Payé:': 'Paid:',
'Impayé:': 'Unpaid:',
'Chronologie des Paiements': 'Payment Timeline',
'jour': 'day',
'Aucune donnée trouvée pour cette convention': 'No data found for this agreement',
'ID de convention non spécifié': 'Agreement ID not specified',
'Erreur lors du chargement du bilan': 'Error loading report',

// Payment status icons text
'Payé en avance': 'Paid in advance',
'Payé en retard': 'Paid late',
'Payé à temps': 'Paid on time',

'CURRENCY_MILLION': 'M',
'CURRENCY_THOUSAND': 'k',
      // Add to 'en' section:
'PERIODICITE_MENSUEL': 'Monthly',
'PERIODICITE_BIMESTRIEL': 'Bimonthly',
'PERIODICITE_TRIMESTRIEL': 'Quarterly',
'PERIODICITE_SEMESTRIEL': 'Semiannual',
'PERIODICITE_ANNUEL': 'Annual',

'Assistant IA': 'AI Assistant',
'En ligne': 'Online',
'Plein écran': 'Fullscreen',
'Bonjour': 'Hello',
'Je suis votre assistant IA. Posez-moi vos questions sur': 'I am your AI assistant. Ask me about',
'Les conventions': 'Agreements',
'Les factures': 'Invoices',
'Les applications': 'Applications',
'Suggestions': 'Suggestions',
'Écrivez votre message...': 'Write your message...',
'Appuyez sur Entrée pour envoyer': 'Press Enter to send',
'envoyé': 'sent',

'Je suis votre assistant IA. Je peux répondre à vos questions sur:': 'I am your AI assistant. I can answer your questions about:',
'Factures (dates d\'échéance, statuts)': 'Invoices (due dates, statuses)',
'Paiements (impayés, montants)': 'Payments (unpaid, amounts)',
'Conventions (expirations, totaux)': 'Agreements (expirations, totals)',
'Applications (chefs de projet, clients)': 'Applications (project managers, clients)',
'Comment puis-je vous aider aujourd\'hui ?': 'How can I help you today?',
'Désolé, je n\'ai pas pu traiter votre question.': 'Sorry, I could not process your question.',
'Désolé, une erreur s\'est produite. Veuillez réessayer.': 'Sorry, an error occurred. Please try again.',
'Il y a {{minutes}} min': '{{minutes}} min ago',
'Il y a {{hours}} h': '{{hours}} hours ago',
'Quelle est la date d\'échéance de la facture': 'What is the due date of invoice',
'Combien de factures sont impayées ?': 'How many invoices are unpaid?',
'Quel est le montant total des conventions en cours ?': 'What is the total amount of active agreements?',
'Quelles sont les conventions qui expirent ce mois-ci ?': 'Which agreements expire this month?',
'Montrer les applications avec leurs chefs de projet': 'Show applications with their project managers',
...
'RÉCAPITULATIF FINANCIER': 'الملخص المالي',
      'Détail des Factures': 'تفاصيل الفواتير',
'RÉCAPITULATIF DES FACTURES': 'ملخص الفواتير',
'Réf. paiement': 'مرجع الدفع',

'Taux de recouvrement' : 'معدل الاسترداد',
'PERIODICITE_MENSUEL': 'شهري',
'PERIODICITE_BIMESTRIEL': 'شهرين',
'PERIODICITE_TRIMESTRIEL': 'ربع سنوي',
'PERIODICITE_SEMESTRIEL': 'نصف سنوي',
'PERIODICITE_ANNUEL': 'سنوي',

      'Bilan de la Convention :' : 'تقرير الاتفاقية :',
'CURRENCY_MILLION': 'مليون',
'CURRENCY_THOUSAND': 'ألف',
      'Bilan des clients' : 'نظرة عامة على العملاء',
...
'Chronologie des Paiements' : 'الجدول الزمني للمدفوعات',
...
// Client Detail Dashboard
'Score Global': 'النتيجة الإجمالية',
'Total Impayé': 'إجمالي غير المدفوع',
'dont': 'بما في ذلك',
'en souffrance': 'متأخر',
'Taux Conformité': 'نسبة الامتثال',
'Distribution Paiements': 'توزيع المدفوعات',
'Évolution Annuelle': 'التطور السنوي',
'Évaluation par Critère': 'تقييم حسب المعيار',
'Points Forts': 'نقاط القوة',
'Points à Améliorer': 'نقاط التحسين',
'Aucun point fort identifié': 'لم يتم تحديد أي نقاط قوة',
'Aucun point faible identifié': 'لم يتم تحديد أي نقاط ضعف',
'Chargement du bilan client...': 'جاري تحميل تقرير العميل...',
'Régénérer': 'تحديث',
'PDF': 'PDF',
'Excel': 'إكسيل',
'Périodicité:': 'الدورية:',
'Utilisateurs:': 'المستخدمين:',
'Taux paiement': 'نسبة الدفع',
'Historique des Factures': 'سجل الفواتير',
'Date Échéance': 'تاريخ الاستحقاق',
'Date Paiement': 'تاريخ الدفع',
'Jours Retard': 'أيام التأخير',
...
'Référence paiement:': 'مرجع الدفع:',
'Timing:': 'التوقيت:',
'Jours de retard:': 'أيام التأخير:',
'Voir Détails': 'عرض التفاصيل',
'Bilan des Clients': 'نظرة عامة على العملاء',
'Gestion et suivi de vos clients': 'إدارة وتتبع عملائك',
'Chargement des clients...': 'جاري تحميل العملاء...',
'Total Clients': 'إجمالي العملاء',
'Score Moyen': 'متوسط النتيجة',
'Total Impayés': 'إجمالي المتأخرات',
'Valeur Totale Contrats': 'القيمة الإجمالية للعقود',
'Distribution des Notes': 'توزيع التقييمات',
'Excellent': 'ممتاز',
'Bon': 'جيد',
'Médiocre': 'ضعيف',
'Filtres': 'مرشحات',
'Nom ou code client...': 'اسم العميل أو الرمز...',
'Clients avec mauvais paiement': 'العملاء ذوي الدفع السيئ',
'Score Minimum': 'الحد الأدنى للنتيجة',
'Liste des Clients': 'قائمة العملاء',
'Score': 'النتيجة',
'Conv.': 'اتفاق.',
'Aucun client trouvé': 'لم يتم العثور على عملاء',
'Aucun comportement de paiement enregistré': 'لا يوجد سلوك دفع مسجل',
'Très mauvais': 'سيء جداً',
'BILAN_GENERATION' : 'إنشاء التقرير',
'Bilan des revenus': 'نظرة عامة على الإيرادات',
'Bilan des conventions et factures': 'نظرة عامة على الاتفاقيات والفواتير',
'Personnalisé': 'مخصص',
'Année': 'سنة',
'Du': 'من',
'Au': 'إلى',
'Type de bilan': 'نوع التقرير',
'Bilan Complet': 'تقرير كامل',
'Bilan des Conventions': 'تقرير الاتفاقيات',
'Bilan des Factures': 'تقرير الفواتير',
'Génération du bilan en cours...': 'جاري إنشاء التقرير...',
'Détail des éléments': 'تفاصيل العناصر',
'HT': 'بدون ضريبة',
'Structure': 'الهيكل',
'Fact.': 'فاتورة',
'Aucune donnée trouvée pour la période sélectionnée': 'لا توجد بيانات للفترة المحددة',
'Conv': 'اتفاقية',
'Anc': 'مؤرشف',
'Fact': 'فاتورة',
'En cours': 'قيد التنفيذ',
...
'MOIS_JUILLET': 'جويلية',
'MOIS_AOUT': 'أوت',
'MOIS_SEPTEMBRE': 'سبتمبر',
'MOIS_OCTOBRE': 'أكتوبر',
'MOIS_NOVEMBRE': 'نوفمبر',
'MOIS_DECEMBRE': 'ديسمبر',
// Arabic
'BILAN_GLOBAL': 'تقرير شامل (الاتفاقيات + الفواتير)',
'BILAN_CONVENTIONS': 'تقرير الاتفاقيات',
'BILAN_FACTURES': 'تقرير الفواتير',
'BILAN': 'تقرير',
...
'Bonjour': 'مرحباً',
'Je suis votre assistant IA. Posez-moi vos questions sur': 'أنا مساعدك الذكي. اسألني عن',
'Les conventions': 'الاتفاقيات',
'Les factures': 'الفواتير',
'Les applications': 'التطبيقات',
'Suggestions': 'اقتراحات',
'Écrivez votre message...': 'اكتب رسالتك...',
'Appuyez sur Entrée pour envoyer': 'اضغط Enter للإرسال',
'envoyé': 'مرسل',

'Factures (dates d\'échéance, statuts)': 'الفواتير (تواريخ الاستحقاق، الحالات)',
'Paiements (impayés, montants)': 'المدفوعات (غير المدفوعة، المبالغ)',
'Conventions (expirations, totaux)': 'الاتفاقيات (الانتهاء، الإجماليات)',
'Applications (chefs de projet, clients)': 'التطبيقات (مديري المشاريع، العملاء)',
'Comment puis-je vous aider aujourd\'hui ?': 'كيف يمكنني مساعدتك اليوم؟',
'Désolé, je n\'ai pas pu traiter votre question.': 'عذراً، لم أتمكن من معالجة سؤالك.',
'Désolé, une erreur s\'est produite. Veuillez réessayer.': 'عذراً، حدث خطأ. يرجى المحاولة مرة أخرى.',
'Il y a {{minutes}} min': 'منذ {{minutes}} دقيقة',
'Il y a {{hours}} h': 'منذ {{hours}} ساعة',
'Quelle est la date d\'échéance de la facture': 'ما هو تاريخ استحقاق الفاتورة',
'Combien de factures sont impayées ?': 'كم عدد الفواتير غير المدفوعة؟',
'Quel est le montant total des conventions en cours ?': 'ما هو المبلغ الإجمالي للاتفاقيات النشطة؟',
'Quelles sont les conventions qui expirent ce mois-ci ?': 'ما هي الاتفاقيات التي تنتهي هذا الشهر؟',
'Montrer les applications avec leurs chefs de projet': 'عرض التطبيقات مع مديري مشاريعهم',
}
  };
